...
var client = redis.createClient(6379, '192.168.33.95', {});
...
exports.createStudy = function (req, res) {
    ...
    client.get("CREATE_STUDY_FLAG", function (err, value) {
                    ...
                    collection.insert(study, {
                        ...
                        if (err) {
                            ...
                            collection.update({
                                    ...
                                    '$set': {
                                        'publicLink': study.publicLink
                                    }
                                },
                                function (err, result) {
                                    sendStudyEmail(study);
                                    res.send({
                                        admin_url: study.adminLink
                                    });
                                });
                        }
                    });
